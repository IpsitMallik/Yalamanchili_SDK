...
public class UpdateCustomerRequest {
	...
	public static class CustomerInfo {
		...
		@XmlElementName("FutureUse")
		private FutureUse futureUse;
		 ...
		 * @return future use
		 */
		public FutureUse getFutureUse() {
			return futureUse;
		}

		/**
		 * @param futureUse the future use to set
		 */
		public void setFutureUse(FutureUse futureUse) {
		...
		public String toString() {
			...
			builder.append("CustomerInfo [title=").append(title).append(", firstName=").append(firstName)
					...
					.append(identificationType).append(", futureUse=").append(futureUse)
					.append("]");
			return builder.toString();
		}
		...
		public static class FutureUse {
			...
			public String toString() {
				StringBuilder builder = new StringBuilder();
				builder.append("CardRequest [refText1=").append(refText1).append(", refText2=")
						.append(refText2).append(", refText3=").append("]");
				return builder.toString();
			}
		}
	}
