 ...
 *
 */
@WebServiceClient(name = "NaradaApiService",
                  wsdlLocation = "file:/D:/OpenTurf_Technologies/Projects/NaradaApiService.wsdl",
                  targetNamespace = "http://services.api.ycs.com")
public class NaradaApiService extends Service {
    ...
    public static final QName NaradaApiServiceHttpEndpoint = new QName("http://services.api.ycs.com", "NaradaApiServiceHttpEndpoint");
    public static final QName NaradaApiServiceHttpSoap11Endpoint = new QName("http://services.api.ycs.com", "NaradaApiServiceHttpSoap11Endpoint");
    public static final QName NaradaApiServiceHttpSoap12Endpoint = new QName("http://services.api.ycs.com", "NaradaApiServiceHttpSoap12Endpoint");
    static {
        URL url = null;
        try {
            url = URI.create("file:/D:/OpenTurf_Technologies/Projects/NaradaApiService.wsdl").toURL();
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NaradaApiService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/OpenTurf_Technologies/Projects/NaradaApiService.wsdl");
        }
        WSDL_LOCATION = url;
    }
