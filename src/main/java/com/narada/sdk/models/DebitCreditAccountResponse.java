...
public class DebitCreditAccountResponse {
	...
	public String toString() {
		...
		builder.append("DebitCreditAccountResponse [txnRefNo=").append(txnRefNo).append(", proxyNumber=")
				.append(proxyNumber).append(", productCode=").append(productCode).append(", balanceAmount=")
				.append(balanceAmount).append("]");
