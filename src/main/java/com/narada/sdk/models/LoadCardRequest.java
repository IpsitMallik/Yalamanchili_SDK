...
public class LoadCardRequest {
	...
	public String toString() {
		...
		builder.append("LoadCardRequest [txnRefNo=").append(txnRefNo).append(", proxyNumber=").append(proxyNumber)
	...
	public static class ProductInfo {
		...
		public String toString() {
			StringBuilder builder = new StringBuilder();
			builder.append("ProductInfo [productCode=").append(productCode).append(", loadAmount=").append(loadAmount)
