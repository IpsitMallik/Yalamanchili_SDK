...
public class CardNumberRequest {
	...
	public String toString() {
		...
		builder.append("CardNumberRequest [txnRefNo=").append(txnRefNo).append(", proxyNumber=").append(proxyNumber)
				.append(", reftext1=").append(reftext1).append(", reftext2=").append(reftext2)
				.append(", reftext3=").append(reftext3).append("]");
