...
import com.narada.sdk.models.AddAccountRequest.ProductInfo.Details;
...
import com.narada.sdk.models.CorporateRegistrationRequest.Corporate.Branch;
import com.narada.sdk.models.CorporateRegistrationRequest.Corporate.Branch.ContactDetails;
...
import com.narada.sdk.models.UpdateCustomerRequest.CustomerInfo;
import com.narada.sdk.models.UpdateCustomerRequest.CustomerInfo.IdentificationType;
...
import com.narada.sdk.models.UpdateExchangeRateRequest.Detail;
...
public class AccountPayload {
	...
	public static void addAccountPayLoad(AddAccountRequest request) throws ValidationFailedException {
		...
		if (request.getProductInfo().getDetailsList() != null) {
			for (Details details : request.getProductInfo().getDetailsList()) {
			...
			throw new ValidationFailedException("At least one ProductInfo/Detail must be provided.");
		}
	}
	...
	private static void validateCustomerInfo(CustomerInfo customerInfo) throws ValidationFailedException {
		...
		if (customerInfo.getIdentificationTypes() != null) {
			for (IdentificationType idType : customerInfo.getIdentificationTypes()) {
